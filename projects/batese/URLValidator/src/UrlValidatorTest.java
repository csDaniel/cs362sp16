...
public class UrlValidatorTest extends TestCase {
   ...
   public void testAnyOtherUnitTest()
   {
	   ...
	   // 80 has passed, try powers of 2 greater
	   int port;
	   System.out.println("These port number should all return true:");
	   // Test valid port numbers
	   for (port = 128; port < 65535; port = port * 2) {
	   System.out.println("Testing port " + port + ":");
	   String thisURL = url + port;
	   System.out.println(urlVal.isValid(thisURL));
	   }
   }
