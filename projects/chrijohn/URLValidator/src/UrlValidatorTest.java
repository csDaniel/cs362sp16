...
public class UrlValidatorTest extends TestCase {
   ...
   public void testIsValid()
   {
	   ...
	   piece[] schemes = {
			   new piece("", true),   // Note: I changed this
			   new piece("http:", true),
	   ...
	   piece[] authorityHosts = { //TODO split this up to test all .com, .org, etc.  Also, add port IPV4 and IPV6 tests.  Need to add www tests too
			   ...
			   new piece("host.org", true),
			   new piece("", false),
			   new piece("www.host.com",true),
			   new piece("host.ca",true),
			   new piece("host123.com",true),
			   new piece("123.com",true),
	  ...
	  piece[] slashess = {
	   ...
	   System.out.println("Result|URL|Expected|Actual|");
