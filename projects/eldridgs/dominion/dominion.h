...
int pVillage(struct gameState *state, int handPos);
int pGreatHall(struct gameState *state, int handPos);
int pRemodel(struct gameState *state, int choice1, int choice2, int handPos);
