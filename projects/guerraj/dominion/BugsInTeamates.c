...
Smithy Card: The player draws 4 cards instead of the expected 3.  

Adventurer Card: incorect number of treasure cards placed into hand, and non treasure card among that number
...
unit test output for Ryan Peters code:
Program by James Guerra Result for running unit- tests for cards:
cardtest1.c:
TESTING Smithy Card:
G.handCount = 4, expected = 3
...
G.handCount = 3, expected = 2
Test 1 failed, expected card number not found in hand 
Test 2 passed, expected card number in hand player 2 
Test 3 failed, non-treasure card in hand 
File 'cardtest2.c'
...
unit test output for Michael Loom's code:
Program by James Guerra Result for running unit- tests for cards:
cardtest1.c:
TESTING Smithy Card:
...
code coverage for dominon.c:
File 'dominion.c'
Lines executed:35.44% of 570
Branches executed:44.10% of 415
