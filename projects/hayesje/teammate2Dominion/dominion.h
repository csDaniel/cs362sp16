...
int adventurerCard(int, int, struct gameState *state, int, int*, int);
int smithyCard(int, struct gameState *state, int);
int cutpurseCard(int, struct gameState *state, int);
int salvagerCard(int, struct gameState *state, int, int);
int great_hallCard(int, struct gameState *state, int);
