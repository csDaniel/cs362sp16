 ...
 * --------------------------
 * Simply play smithy card and check the current player's new handCount
 * and deckCount variable values.
 ...
 * Steps to Produce/Reproduce:
 * --------------------------
 * Insert 3 treasure cards into the current player's deck, play adventurer 
 * and observe it draw all 3 treasure cards from the player's deck.
 ...
 * Steps to Produce/Reproduce:
 * --------------------------
 * Simply play council_room card and check the current player's new 
 * handCount and deckCount variable values.
 ...
 * Steps to Produce/Reproduce:
 * --------------------------
 * Play council_room card and check the current player's new 
 * handCount and deckCount variable values.
 ...
 * --------------------------
 * Simply play smithy card and check the current player's new handCount
 * and deckCount variable value*s.
 ...
 * function call and observe that mine card does not return -1 for card
 * enumerations less than curse and greater than treasure_card.
