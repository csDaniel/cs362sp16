...
int main() {
	...
	assert(testG.handCount[currentPlayer] == G.handCount[currentPlayer] + newCards - discarded - 1);
	assert(testG.deckCount[currentPlayer] == G.deckCount[currentPlayer] - newCards + 1);
	...
	// Player 3 Draws
	assert(testG.handCount[2] == G.handCount[2]);
	assert(testG.deckCount[2] == G.deckCount[2]);
	// Player 4 Draws
	assert(testG.handCount[3] == G.handCount[3]);
	assert(testG.deckCount[3] == G.deckCount[3]);
