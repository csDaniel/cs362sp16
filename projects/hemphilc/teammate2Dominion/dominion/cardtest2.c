...
int main() {
	...
	assert(testG.deckCount[currentPlayer] == G.deckCount[currentPlayer] - 7 - 3);
	//printf("test: %d G: %d\n", testG.discardCount[currentPlayer], G.discardCount[currentPlayer]);	
	assert(testG.discardCount[currentPlayer] == G.discardCount[currentPlayer] + 5 + 3);
	...
	assert(testG.handCount[currentPlayer] == G.handCount[currentPlayer] + 2);
	//printf("test: %d G: %d\n", testG.deckCount[currentPlayer], G.deckCount[currentPlayer]);
	assert(testG.deckCount[currentPlayer] == G.deckCount[currentPlayer] - 2 - 8);
	//printf("test: %d G: %d\n", testG.discardCount[currentPlayer], G.discardCount[currentPlayer]);	
	assert(testG.discardCount[currentPlayer] == G.discardCount[currentPlayer] + 0 + 8);	
