...
int main() {
	...
	//assert(cardEffect(mine, 1, treasure_map + 1, choice3, &testG, 1, &bonus) == -1);
	//printf("%d\n", cardEffect(mine, 1, treasure_map + 1, choice3, &testG, 1, &bonus));	
	//assert(cardEffect(mine, 1, curse - 1, choice3, &testG, 1, &bonus) == -1);
	//printf("%d\n", cardEffect(mine, 1, curse - 1, choice3, &testG, 1, &bonus));	
