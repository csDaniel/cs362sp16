...
Sam Jones
Date: 05/06/16
Description: Random tester for the council_room.  
- Test that the function executed properly.
- Tests the player drew four chards from their deck and discarded one card.  
- Tests the other players drew a card.  Tests cards were not removed from supply decks.
*/
