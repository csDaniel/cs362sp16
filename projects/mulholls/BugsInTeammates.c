...
/***************************Tatyana Vlaskin Bugs (Teammate 2) ***************************************************/



Source: dominion.c -> isGameOver(struct gameState*)
...
Source: dominion.c -> card_Aventurer(struct gameState*)
...
Description: There are 8 expected state changes after the card is played:
   ...
   playedCards[]
   playedCardCount
Only 3 states are being affected by the play of adventurer: hand, handCount, and deckCount. None of the others are properly affected. 




Source: dominion.c -> card_Adventurer(struct gameState*)
...
Source: dominion.c -> card_Smithy(struct gameState*)
...
Source: dominion.c -> card_Village(struct gameState*)
