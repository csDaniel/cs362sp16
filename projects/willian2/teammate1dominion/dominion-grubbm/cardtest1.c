/******************************************************************************
* ASSIGNMENT 5 - cardtest1.c
* AUTHOR: Nickolas A. Williams
* CLASS: CS362
* DATE: 05/22/2016
* NOTES: unit testing of Max Grubb's refactored smithy card
...
int main() 
{
	...
	for (i = 0; i < numPlayer; i++)
	{
		...
		int p;
		//p = playSmithy(&TestState, i, 0); -- old test call
		p = cardEffect(smithy, 0, 0, 0, &TestState, 0, 0); //new call
