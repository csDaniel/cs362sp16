...
* CLASS: CS362
* DATE: 05/22/2016
* NOTES: unit testing of Max Grubb's refactored adventurer card
...
int main() 
{
	...
	for (i = 0; i < numPlayer; i++)
	{
		...
		int p;
		//p = playAdventurer(&TestState, i, 0); -- old test call
		p = cardEffect(adventurer, 0, 0, 0, &TestState, 0, 0); //new call
