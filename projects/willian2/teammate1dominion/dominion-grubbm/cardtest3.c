...
* CLASS: CS362
* DATE: 05/22/2016
* NOTES: unit testing of Max Grubb's refactored council_room card
* REQUIREMENTS for council_room:
...
* TESTING tasks for council_room:
...
int main() 
{
	...
	for (i = 0; i < numPlayer; i++)
	{
		...
		int p;
		// p = playCouncilRoom(&TestState, i, 0); --old test call
		p = cardEffect(council_room, 0, 0, 0, &TestState, 0, 0); //new call
