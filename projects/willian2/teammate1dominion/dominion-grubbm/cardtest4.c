/******************************************************************************
* ASSIGNMENT 5 - cardtest4.c
* AUTHOR: Nickolas A. Williams
* CLASS: CS362
* DATE: 05/22/2016
* NOTES: unit testing of Max Grubb's salvager card (not refactored)
* REQUIREMENTS for salvager:
...
int main() 
{
	...
	for (i = 0; i < numPlayer; i++)
	{
		...
		int p;
		//p = playSalvager(&TestState, i, 0, 1); --old test call
		p = cardEffect(salvager, 1, 0, 0, &TestState, 0, 0); //new call, handPos 0 choice pos 1
