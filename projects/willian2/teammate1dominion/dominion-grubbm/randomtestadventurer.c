...
* CLASS: CS362
* DATE: 05/22/2016
* NOTES: random testing Max Grubb's refactored playAdventurer() function
...
int main() 
{
	...
	for (test = 0; test < NUM_TESTS; test++)
	{
		...
		cardEffect(adventurer, 0, 0, 0, &TestState, handPos, 0); //new call
