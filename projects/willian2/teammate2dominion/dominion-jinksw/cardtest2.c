/******************************************************************************
* ASSIGNMENT 5 - cardtest2.c
* AUTHOR: Nickolas A. Williams
* CLASS: CS362
* DATE: 05/22/2016
* NOTES: unit testing of Wesley Jinks's refactored playAdventurer() function
* REQUIREMENTS for playAdventurerCard():
...
int main() 
{
	...
	for (i = 0; i < numPlayer; i++)
	{
		...
		int p;
		//p = playAdventurer(&TestState, i, 0); --old call
		p = playAdventurerCard(&TestState);  //adjusted call
