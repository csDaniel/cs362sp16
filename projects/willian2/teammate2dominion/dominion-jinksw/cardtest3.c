/******************************************************************************
* ASSIGNMENT 5 - cardtest3.c
* AUTHOR: Nickolas A. Williams
* CLASS: CS362
* DATE: 05/22/2016
* NOTES: unit testing of Wesley Jinks's refactored playCouncil_roomCard() function
* REQUIREMENTS for playCouncil_roomCard():
...
* TESTING tasks for playCouncil_roomCard():
...
int main() 
{
	...
	for (i = 0; i < numPlayer; i++)
	{
		...
		int p;
		//p = playCouncilRoom(&TestState, i, 0); --old call
		p = playCouncil_roomCard(&TestState, 0); //adjusted call
